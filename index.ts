...
if (tutionFees === paymentAmount ){
    ...
    if (ans.select === "View Status"){
        ...
        console.log(`Student Id: ${randomNumber}`);                console.log(`Course: ${answer.course}`);
        console.log(`Tution Fees Paid: ${paymentAmount}`);       console.log(`Balance: ${myBalance =+ paymentAmount}`);     
    }else {
